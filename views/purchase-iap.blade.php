@extends('hanoivip::layout') @section('title', 'Pay with paypal')

@section('content')


<script>
function purchaseAndroid(form)
{
	...
	{
		// native device will handle purchase
		Android.buy(0, form['item']);
	}
}
</script>
...
<form method="post" action="{{route('purchase.do')}}" id="purchase.form"
	name="purchase.form">
	{{ csrf_field() }}
